...
# =============================================================================
# PANK Thesis Project - PARALLEL StarDist Cell Segmentation Pipeline (Step 01)
# Copyright (c) 2024 Maxence PELLOUX
# All rights reserved.
#
# This script automates StarDist cell segmentation across multiple QuPath projects
# with PARALLEL processing optimized for 128-core servers.
# =============================================================================

# QuPath and StarDist Configuration
STARDIST_JAR="/u/trinhvq/Documents/maxencepelloux/qupath_gpu_build/qupath/build/dist/QuPath/lib/app/qupath-extension-stardist-0.5.0.jar"
...
show_help() {
    ...
    echo "  $0 -a                           # All projects in parallel"
...
LOG_DIR="logs"
mkdir -p "$LOG_DIR"
LOG_FILE="${LOG_DIR}/pipeline_01_parallel_${TIMESTAMP}.log"
ERROR_LOG="${LOG_DIR}/pipeline_01_parallel_${TIMESTAMP}_error.log"
...
# Initialize
echo "==============================================="
echo "     PANK Thesis - Pipeline Step 01 PARALLEL"
...
log "Starting PARALLEL StarDist cell segmentation pipeline (Step 01)"
...
# Function to process a single project (runs in background)
process_project() {
    ...
    log "Starting job $job_id: Processing project $project_name"
...
echo "  Average time per project: $((total_time / (successful_projects + failed_projects))) seconds"
